    ...
    candidateContainers.forEach(container => {
        container.addEventListener('click', function () {
            ...
            if (this.classList.contains('selected')) {
                ...
                if (maxVotes === 1) {
                    // Automatically deselect the currently selected candidate
                    const currentlySelected = document.querySelector(`.candidate-container[data-position='${position}'].selected`);
                    if (currentlySelected) {
                        currentlySelected.classList.remove('selected');
                        currentlySelected.classList.add('unselected');
                    }
                }
