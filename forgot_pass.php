              ...
              <div class="actual-form has-feedback">
                ...
                <div class="input-wrap" style="display: flex;">
                  ...
                  />
                    <span class="form-control-feedback"></span>
                  <label style="font-size:15px;"></label>
                  <input type="button" name="sendOTP" id="sendOTP" value="Send OTP" class="sign-btn" style="width: 100px; font-size:15px; justify-content: flex-start; background-color: grey;">
                </div>
            </div>
