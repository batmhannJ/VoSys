...
include 'includes/header_pasoa.php';
		...
		<div class="container">
		  ...
		  <section class="content">
			  <h1 class="page-header text-center title">
				  <img src="images/p.png" alt="CSC Logo" style="width: 100px; height: 100px; border-radius: 50%; margin-right: 10px;">
				  <b>Philippine Association of Students in Office Administration Election</b></h1>
			<div class="row">
