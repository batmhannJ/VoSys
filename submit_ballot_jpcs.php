					...
					if($row['max_vote'] > 1){
						if(count($_POST[$position]) > $row['max_vote']){
							...
							foreach($_POST[$position] as $key => $values){
								$sql_array[] = "INSERT INTO votes (voters_id, candidate_id, category_id, organization) VALUES ('".$voter['id']."', '$values', '$pos_id', 'JPCS')";
							}
						...
						$sql_array[] = "INSERT INTO votes (voters_id, candidate_id, category_id, organization) VALUES ('".$voter['id']."', '$candidate', '$pos_id', 'JPCS')";
					}
