...
<div class="wrapper">
	...
	<?php include 'includes/navbar_pasoa.php'; ?>
	    ...
	    <div class="container">
	      ...
	      <section class="content">
	      	<h1 class="page-header text-center title">
	      		<img src="images/posoa.jpg" alt="CSC Logo" style="width: 100px; height: 100px; border-radius: 50%; margin-right: 10px;">
	      	<b>PASOA - Philippine Association of Students in Office Administration Election</b></h1>
	        <div class="row">
	        	<div class="col-sm-10 col-sm-offset-1">
                    ...
                    <?php
                        ...
                        if($vquery->num_rows > 0){
                            ...
                            ?>
                            <!-- Voting Ballot -->
                            <form method="POST" id="ballotForm" action="submit_ballot_pasoa.php">
                                <?php
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary" id="submitBtn" name="vote_pasoa">Yes, Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
  	...
  	<?php include 'includes/ballot_modal_pasoa.php'; ?>
</div>
