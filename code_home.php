		...
		<div class="container">
			...
			<section class="content">
				<h1 class="page-header text-center title">
					<img src="images/codg.jpg" alt="CSC Logo" class="header-logo">
					<b>Coalition of Disciplined Future Enforcers of Today's Generation Election</b>
				</h1>
				<div class="row">
						...
						<?php
							...
							if($vquery->num_rows > 0){
								...
								<div class='text-center'>
									...
									<a href='#view' data-toggle='modal' class='btn btn-primary btn-lg'>View Ballot</a>
								</div>";
							}
							else{
						?>
