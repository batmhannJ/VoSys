...
<div class="wrapper">
	...
	<?php include 'includes/navbar_educ.php'; ?>
	    ...
	    <div class="container">
	      ...
	      <section class="content">
	      	<h1 class="page-header text-center title">
	      		<img src="images/ymf.jpg" alt="CSC Logo" style="width: 100px; height: 100px; border-radius: 50%; margin-right: 10px;">
	      		<b>YMF - Young Mentor of the Future Election</b></h1>
	        <div class="row">
                                    ...
                                    echo '
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="box-header with-border"style="background-color: darkblue; color: #fff;"> 
  	...
  	<?php include 'includes/ballot_modal_educ.php'; ?>
</div>
