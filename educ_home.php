	        	...
	        	<div class="col-sm-10 col-sm-offset-1">
				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
				    		...
				    		?>
			    			<!-- Voting Ballot -->
						    <form method="POST" id="ballotForm" action="submit_ballot_educ.php">
				        		<?php
				        		...
				        		<div class="text-center">
					        		...
					        		<button type="submit" class="btn btn-primary btn-flat" name="vote_educ"><i class="fa fa-check-square-o"></i> Submit</button>
					        	</div>
				        	</form>
				        	<!-- End Voting Ballot -->
				    		<?php
