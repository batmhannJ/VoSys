...
<?php include 'includes/header_hmso.php';

function is_active_election($conn){
	$sql = "SELECT * FROM election WHERE title = 'HMSO - Hospitality Management Students' Organization Election' && status = 1";
...
if(!is_active_election($conn)){
	header("location: no_election_hmso.php");
	exit();
}
...
<div class="wrapper">
    ...
    <?php include 'includes/navbar_hmso.php'; ?>
        ...
        <div class="container">
            ...
            <section class="content">
                <h1 class="page-header text-center title">
                    <img src="images/hmso.jpg" alt="CSC Logo" style="width: 100px; height: 100px; border-radius: 50%; margin-right: 10px;">
                    <b>HMSO - Hospitality Management Students Organization Election</b>
                </h1>
                <div class="row">
                    ...
                    <?php
                        ...
                        if($vquery->num_rows > 0){
                            ...
                            ?>
                            <!-- Voting Ballot -->
                            <form method="POST" id="ballotForm" action="submit_ballot_hmso.php">
                                <?php
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary" id="submitBtn" name="vote_hmso">Yes, Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <?php include 'includes/ballot_modal_hmso.php'; ?>
</div>
