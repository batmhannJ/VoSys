          ...
          <div class="box">
            ...
            <div class="box">
              <div class="box-header with-border">
                <button class="btn btn-success btn-sm" id="batch-restore"><i class="fa fa-reply"></i> Batch Restore</button>
                <button class="btn btn-danger btn-sm" id="batch-delete"><i class="fa fa-trash"></i> Batch Delete</button>
              </div>
              <div class="box-body">
