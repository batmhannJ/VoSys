...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Ranking of Vice President Candidates for Internal Affairs</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <?php
                                // Fetch and display vice president candidate ranking for internal affairs based on vote count and organization filter
                                $sql = "SELECT voters1.organization, CONCAT(candidates.firstname, ' ', candidates.lastname) AS candidate_name, 
                                        ...
                                        AND categories.name = 'Vice President for Internal Affairs'".$organizationFilter."
            ...
            <!-- Vice President for Internal Affairs Bar Graph -->
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Vice President Candidates for Internal Affairs Vote Count</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
...
<script>
    ...
    // Fetch and process vice president data for internal affairs
    <?php
