...
<div class='header-container'>
  ...
  <p class='report-title' style='font-size: 16px; margin-top: -500px;'>2024 Election Results</p>
  <img src='images/logo.png' alt='Logo' style='height: 70px; width: 70px; float: left; top: -100px;'>
</div>
<table>
    <thead>
    <tr>
