...
if (isset($_POST['election_id'])) {
    ...
    // Fetch categories and candidates for the election
        ...
        foreach ($candidates as $candidate) {
            $candidate_list .= '
                <li>
                    ...
                    ' . ($candidate['votes'] >= $max_vote ? '<span class="label label-success">Winner</span>' : '') . '
                </li>
            ';
        }
    ...
    // Return the election data and voter stats as JSON
    $response = [
