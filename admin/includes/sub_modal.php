    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="sub_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="password" class="col-sm-3 control-label">Create password</label>
                ...
                <div class="modal-header">
                  <h4 class="modal-title"><b>Please confirm by entering your password</b></h4>
                </div>
                <div class="modal-body">
            <div class="form-group">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="sub_edit.php">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="sub_delete.php">
                <input type="hidden" class="id" name="id">
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="sub_upload.php" enctype="multipart/form-data">
                <input type="hidden" class="id" name="id">
                <div class="form-group">
                    <label for="photo" class="col-sm-3 control-label">Photo</label>
