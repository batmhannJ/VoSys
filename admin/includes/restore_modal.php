...
<div id="electionConfirmationModal" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success" id="confirmRestoreElection">Restore</button>
          </div>
        </div>
      </div>
    </div>

        <!-- Confirmation Modal for Election Delete -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            <button type="button" class="btn btn-danger" id="confirmDeleteElection">Delete</button>
          </div>
        </div>
      </div>
    </div>
