  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Remaining Voters</li>
      </ol>
    </section>
    <!-- Main content -->
              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = "SELECT id, lastname, firstname, photo, voters_id, email, yearLvl, organization FROM voters WHERE id NOT IN (SELECT DISTINCT voters_id FROM votes) AND archived = 0";
