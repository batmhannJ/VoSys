...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    $sql_total_voters_voted = "SELECT COUNT(DISTINCT voters_id) AS total_voters_voted
                               FROM votes";
    $result_total_voters_voted = $conn->query($sql_total_voters_voted);
    $row_total_voters_voted = $result_total_voters_voted->fetch_assoc();
    $totalVotersVoted = $row_total_voters_voted['total_voters_voted'];

    // Calculate and display the percentage of voters who have voted
    if ($totalVotersVoted > 0) {
        $percentage = ($totalVotersVoted / $totalNumberOfVoters) * 100;
