...
<div class="wrapper">
    ...
    // Assuming you have the voter's ID stored in a session variable
    ...
    // Map of organizations to their corresponding representative categories
    $organization_rep_map = [
        'JPCS' => 'BSIT Rep',
        'HMSO' => 'BSHM Rep',
        'PASOA' => 'BSOAD Rep',
        'CODE-TG' => 'BS CIRM Rep',
